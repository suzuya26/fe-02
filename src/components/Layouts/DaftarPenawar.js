...
export default function FullWidthTextField() {
  ...
  useEffect(() => {
    ...
    function getListPenawaran() {
      axios
        .get(
          `https://secondhand-kelompok2.herokuapp.com/api/v1/getpenawaran/${idproduk}`
        )
        .then((response) => {
                    ...
                    <Grid container>
                      ...
                      <Grid item ml={2}>
                        <Grid
                          ...
                          justifyContent="space-between"
                        >
                          {tawar.statustawar === "menawar" ? (
                            <Link
                              to={
                                "/detail-tawaran/" + produk.id + "--" + tawar.id
                              }
                          ...
                          ) : tawar.statustawar === "diterima" ? (
                            <a
                              href={"https://wa.me/" + tawar.pembeli.nohp}
                              target="_blank"
                              style={{ textDecoration: "none" }}
                            >
                              <Button
